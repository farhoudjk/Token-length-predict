...
class CoreWorkerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CancelRemoteTask = channel.unary_unary(
                '/ray.rpc.CoreWorkerService/CancelRemoteTask',
                request_serializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.CancelRemoteTaskRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.CancelRemoteTaskReply.FromString,
                )
...
class CoreWorkerServiceServicer(object):
    ...
    def CancelRemoteTask(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CoreWorkerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CancelRemoteTask': grpc.unary_unary_rpc_method_handler(
                    servicer.CancelRemoteTask,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.CancelRemoteTaskRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.CancelRemoteTaskReply.SerializeToString,
            ),
...
class CoreWorkerService(object):
    ...
    def CancelRemoteTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.CoreWorkerService/CancelRemoteTask',
            src_dot_ray_dot_protobuf_dot_core__worker__pb2.CancelRemoteTaskRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_core__worker__pb2.CancelRemoteTaskReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
