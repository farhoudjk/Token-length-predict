#!/usr/bin/env python3
"""
Final training script for output token length prediction.
Fixed eval_metric placement and early stopping handling.
"""
...
SELECTED_MODELS = [
    #"llama-3.1-8b-dolly",
    #"llama-3.1-8b-mixed",
    # Uncomment more if you want to include them
     "mistral-7b-dolly",
     "mistral-7b-mixed",
]
...
OUTPUT_COL = "output_tokens"          # ← double-check this matches your CSV column!
MIN_OUTPUT_TOKENS = 5

USE_3CLASS = False # Set to True for short/medium/long classification, False for binary short vs long/medium
if USE_3CLASS:
    THRESHOLD_1 = 500
    THRESHOLD_2 = 2000
...
# Diagnostic prints to help debug low accuracy
