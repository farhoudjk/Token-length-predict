...
OUTPUT_DIR = "out/clf_3class_results_smote"  # SMOTE-enhanced results
...
# Apply SMOTE with k_neighbors=5 (default)
# For the minority class (long), we need at least 6 samples for k_neighbors=5
...
print(f"Training set size increased from {len(X_train)} to {len(X_train_resampled)}")
